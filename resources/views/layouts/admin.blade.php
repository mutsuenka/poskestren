...
{{--        <link rel="stylesheet" href="https://fonts.bunny.net/css2?family=Nunito:wght@400;600;700&display=swap">--}}
    ...
    <body class="font-sans antialiased">
        ...
        -translate-x-full bg-teal-500 border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
               aria-label="Sidebar">
            <div class="h-full px-3 pb-4 overflow-y-auto bg-teal-500 dark:bg-gray-800">
                <ul class="space-y-2">
                    ...
                    <!-- Log -->
                    <li class="text-white hover:text-gray-900 hover:bg-gray-100 rounded px-4" >
                        <a href="{{ route('visit.log') }}" class="flex items-center p-2 text-base font-medium
                             rounded-lg  hover:text-gray-900 group-hover:text-gray-900">
                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                <path fill-rule="evenodd" d="M7.502 6h7.128A3.375 3.375 0 0118 9.375v9.375a3 3 0 003-3V6.108c0-1.505-1.125-2.811-2.664-2.94a48.972 48.972 0 00-.673-.05A3 3 0 0015 1.5h-1.5a3 3 0 00-2.663 1.618c-.225.015-.45.032-.673.05C8.662 3.295 7.554 4.542 7.502 6zM13.5 3A1.5 1.5 0 0012 4.5h4.5A1.5 1.5 0 0015 3h-1.5z" clip-rule="evenodd" />
                            ...
                            <span class="ml-3">Log Visit</span>
                        </a>
                    </li>
        ...
        <div class="p-4 md:ml-64" style="background-image: url(logo_postren.jpg)">
            <!-- Page Heading -->
            @if (isset($header))
